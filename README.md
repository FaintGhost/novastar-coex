...
This library supports API version 1.4, which requires COEX processors with firmware versions 1.4.0 and above. The legacy API support (v1.0-1.3) has been removed.

```javascript
const Novastar = require("novastar-coex");
const novastar = new Novastar("192.168.1.101");
```
